...
#define WINDOW_WIDTH  600 //1700  // 600
#define WINDOW_HEIGHT 690 //700 //250

MyFrame::MyFrame()
    : wxFrame(nullptr, wxID_ANY, "Alamos Chess (6x6) - AlphaGo Zero",
        wxDefaultPosition,
        ...
        wxDEFAULT_FRAME_STYLE & ~(wxRESIZE_BORDER | wxMAXIMIZE_BOX))
{
    ...
    _menuPlayWith->Append(ID_Play_GAME, "Play Game","", wxItemKind::wxITEM_CHECK);
...
void MyFrame::OnPlay_Game(wxCommandEvent& event)
{
...
void MyFrame::OnPlay_RuleBasedBot(wxCommandEvent& event)
{
    ...
    _menuPlayWith->Check(ID_Play_GAME, false);
}
