        ...
        wxDEFAULT_FRAME_STYLE & ~(wxRESIZE_BORDER | wxMAXIMIZE_BOX))
{
    ...
    wxMenu* menuPlayWith = new wxMenu;
    menuPlayWith->Append(ID_Play_HITL, "Human in the Loop", "", wxItemKind::wxITEM_CHECK);
    menuPlayWith->Append(ID_Play_AgentProcedural, "Rule-Based Bot", "", wxItemKind::wxITEM_CHECK);
    ...
    menuBar->Append(menuPlayWith, "&Play");
